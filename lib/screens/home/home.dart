...
Route _createRoute1() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => Feeding(),
...
// Route _createRoute2() {
//   return PageRouteBuilder(
//     pageBuilder: (context, animation, secondaryAnimation) => Nursing(),
//     transitionsBuilder: (context, animation, secondaryAnimation, child) {
//       return child;
//     },
//   );
...
Route _createRoute3() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => FlutterStopWatch(),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      return child;
    },
  );
...
Route _createRoute4() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => Diaper(),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      return child;
    },
  );
